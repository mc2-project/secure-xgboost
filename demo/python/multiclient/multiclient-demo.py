...
KEY_FILE_1 = HOME_DIR + "demo/multiclient-data/key1.txt"
KEY_FILE_2 = HOME_DIR + "demo/multiclient-data/key2.txt"
...
train_enc_1 = HOME_DIR + "demo/multiclient-data/train1.enc"
train_enc_2 = HOME_DIR + "demo/multiclient-data/train2.enc"
test_enc = HOME_DIR + "demo/multiclient-data/test.enc"
...
# Load test data
dtest = xgb.DMatrix([test_enc], encrypted=True, usernames=["user1"])
...
xgb.set_user("user2")
test_data = HOME_DIR + "demo/data/agaricus.txt.test"
test_enc_duplicate = HOME_DIR + "demo/multiclient-data/test_duplicate.enc"

# Encrypt test data with user 2's key

crypto.encrypt_file(test_data, test_enc_duplicate, KEY_FILE_2)
dtest_u2 = xgb.DMatrix([test_enc_duplicate], encrypted=True, usernames=["user2"])
