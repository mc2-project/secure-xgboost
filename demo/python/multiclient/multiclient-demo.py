...
training_data_1 = HOME_DIR + "demo/multiclient-data/1_2agaricus.txt.train"
train_enc_1 = HOME_DIR + "demo/multiclient-data/train1.enc"
test_data = HOME_DIR + "demo/multiclient-data/agaricus.txt.test"
test_enc_1 = HOME_DIR + "demo/multiclient-data/test1.enc"
...
training_data_2 = HOME_DIR + "demo/multiclient-data/2_2agaricus.txt.train"
train_enc_2 = HOME_DIR + "demo/multiclient-data/train2.enc"
test_enc_2 = HOME_DIR + "demo/multiclient-data/test2.enc"
