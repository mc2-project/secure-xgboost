...
# Load training data
dtrain = xgb.DMatrix(os.getcwd() + "/" + enc_training_data, encrypted=True, username= "user1")
...
# Load test data
dtest = xgb.DMatrix(os.getcwd() + "/" + enc_test_data, encrypted=True, username = "user1")
...
print("user 1 in charge")
enc_preds, num_preds = booster.predict(dtest, username = "user1")
...
print("file encryption is good")
dtest = xgb.DMatrix(os.getcwd() + "/" + enc_test_data, encrypted=True, username = "user2")
