...
Secure XGBoost is a library for **privacy-preserving training and inference** of `XGBoost <https://github.com/dmlc/xgboost>`_ models.
...
At its core, Secure XGBoost uses `secure hardware enclaves <https://en.wikipedia.org/wiki/Trusted_execution_environment>`_ (such as Intel SGX) to protect the data in use even in the presence of a hostile cloud environment.
