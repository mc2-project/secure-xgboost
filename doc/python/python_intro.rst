...
###########################
This document gives a basic walkthrough of the Secure XGBoost python package. There's also a `sample Jupyter notebook <https://nbviewer.jupyter.org/github/mc2-project/secure-xgboost/blob/master/demo/python/jupyter/e2e-demo.ipynb>`_ at ``demo/python/jupyter/e2e-demo.ipynb``.
