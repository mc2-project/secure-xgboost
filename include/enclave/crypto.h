...
static int encrypt_symm(unsigned char* key,
...
static int encrypt_symm(mbedtls_gcm_context* gcm,
    mbedtls_ctr_drbg_context* ctr_drbg,
    const unsigned char* data,
    size_t data_len,
    unsigned char* aad,
...
static int decrypt_symm(unsigned char* key,
    const unsigned char* data,
    size_t data_len,
    unsigned char* iv,
    unsigned char* tag,
...
static int decrypt_symm(mbedtls_gcm_context* gcm,
    const unsigned char* data,
    size_t data_len,
    unsigned char* iv,
    unsigned char* tag,
...
/*
void verifySignature(char *pkfile, uint8_t* data, size_t data_size,
  ...
  if((ret = mbedtls_pk_parse_pub

   printf(" failed\n  ! Could not read key\n");
    printf("  ! mbedtls_pk_parse_pub
